...
X_test_vectorized = vectorizer.transform(X_test) # store matrix tokens in the X_test_vectorized variable

model = MultinomialNB()
model.fit(X_train_vectorized, y_train)
predictions = model.predict(X_test_vectorized) # pass the stored matrix tokens in to the model
